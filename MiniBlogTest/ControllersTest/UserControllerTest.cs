namespace MiniBlogTest.ControllerTest
{
    ...
    public class UserControllerTest
    {
        ...
        public async Task Should_register_user_fail_when_UserStore_unavailable()
        {
            ...
            {
                builder.ConfigureServices(services => { services.AddSingleton(service => userStoreMocker.Object); });
            }).CreateClient();
        ...
        private HttpClient GetClient()
        {
            ...
            {
                builder.ConfigureServices(services => { services.AddSingleton(service => _userStore); });
            }).CreateClient();
        }
    }
}